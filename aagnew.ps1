...
<#
$AlwaysonAgPrimaryReplicaHostName = "yyy01"
$AlwaysonAgPrimaryReplicaInstanceName = "mssqlserver"
$AlwaysonAgSecondaryReplicaHostname = "yyy02"	
$AlwaysonAgSecondaryReplicaInstanceName = "mssqlserver"
$DomainFull = "msapp.local"
$DomainName = "msapp"
$AlwaysonAgHadrEndpointName2 = "endpoint2"
$AlwaysonAgHadrEndpointName = "endpoint1"
$AlwaysonAgDatabaseName = "aagdb19"
$AlwaysonAgName = "ag19"
$DomainAccountUserName = "administrator"
$DomainAccountPassword = "Password01!"
$alwaysonAgBackupLocation = "\\msdc\aag"
$AlwaysonListenerOption = $true
$AlwaysonAgListenerName = "AAGLSR"
$AlwaysonAgListenerStaticIp ="10.110.68.147"
$AlwaysonAgListenerNetMask = "255.255.255.0"
[int]$AlwaysonAgListenerPort = 1433
#>
...
if ($db.name -ne $AlwaysonAgDatabaseName){
    Write-Output "database $AlwaysonAgDatabaseName does not exist creating now"
...
#check_endpoints $AlwaysonAgHadrEndpointName2 $hadrEndpoint $AlwaysonAgSecondaryReplicaHostname $AlwaysonAgSecondaryReplicaInstanceName
 ...
 Invoke-Command -ComputerName $SecondaryHostName -Authentication Credssp -Credential $credentials -ScriptBlock {
  param( $alwaysonAgSecondaryReplicaServerInstance,$AlwaysonAgHadrEndpointName2,$SecondaryHostName, $AlwaysonAgSecondaryReplicaInstanceName, $AlwaysonAgHadrEndpointPort)
  Import-Module "sqlps" –DisableNameChecking
  [System.Reflection.Assembly]::LoadWithPartialName('Microsoft.SqlServer.SMO') | out-null
  ...
  $hadrEndpoint = $serverSecondary.Endpoints |
				...
				Select-Object -First 1
    if($hadrEndpoint -eq $null){
        Write-Output "Creating endpoint '$AlwaysonAgHadrEndpointName2' on server '$SecondaryHostName'"
        New-SQLHADREndpoint -Name $AlwaysonAgHadrEndpointName2 -Port $AlwaysonAgHadrEndpointPort -Path "SQLSERVER:\SQL\$SecondaryHostName\$AlwaysonAgSecondaryReplicaInstanceName" 
        Set-SqlHadrEndpoint -Path "SQLSERVER:\SQL\$SecondaryHostName\$AlwaysonAgSecondaryReplicaInstanceName\Endpoints\$AlwaysonAgHadrEndpointName2" -State Started
     }
    else
	{
	    Write-Output "An endpoint for DatabaseMirroring already exists on '$SecondaryHostName'. Skipping endpoint creation."
	}
 } -ArgumentList  $alwaysonAgSecondaryReplicaServerInstance,$AlwaysonAgHadrEndpointName2,$SecondaryHostName, $AlwaysonAgSecondaryReplicaInstanceName, $AlwaysonAgHadrEndpointPort 
...
Invoke-Command -ComputerName $SecondaryHostName -Authentication Credssp -Credential $credentials -ScriptBlock {
    param($dbuser,$alwaysonAgSecondaryReplicaServerInstance,$query,$queryrole)
[System.Reflection.Assembly]::LoadWithPartialName('Microsoft.SqlServer.SMO') | out-null
$serverSecondary =New-Object ('Microsoft.SqlServer.Management.Smo.Server') $alwaysonAgSecondaryReplicaServerInstance
...
if ($dba -eq $null)
{
    ...
    Invoke-Command -ComputerName $SecondaryHostName -Authentication Credssp -Credential $credentials -ScriptBlock {
    param($alwaysonAgSecondaryReplicaServerInstance,$query,$queryrole)
    ...
    } -ArgumentList $alwaysonAgSecondaryReplicaServerInstance,$query,$queryrole
...
} -ArgumentList $dbuser,$alwaysonAgSecondaryReplicaServerInstance,$query,$queryrole
...
{
        Write-Output "$alwaysonAgPrimaryReplicaServerInstance HADR is already enabled" 
}
...
Write-Output "SQL Server Service account for $PrimaryHostname is changed to $cmdUser"
...
Write-Output "SQL Server Servce restart completed"
...
Invoke-Command -ComputerName $SecondaryHostName -Authentication Credssp -Credential $credentials -ScriptBlock {
    ...
    {
        Write-Output "$alwaysonAgSecondaryReplicaServerInstance HADR is already enabled" 
    }
...
Invoke-Command -ComputerName $PrimaryHostName -Authentication Credssp -Credential $credentials -ScriptBlock {
param($AlwaysonAgName,$AlwaysonAgDatabaseName,$alwaysonAgBackupLocation,$alwaysonAgPrimaryReplicaServerInstance,$alwaysonAgSecondaryReplicaServerInstance,$AlwaysonAgPrimaryReplicaHostName,$AlwaysonAgSecondaryReplicaHostname,$DomainFull,$AlwaysonAgHadrEndpointPort,$AlwaysonAgPrimaryReplicaInstanceName,$AlwaysonAgSecondaryReplicaInstanceName)
...
#} -ArgumentList $AlwaysonAgName,$AlwaysonAgDatabaseName,$alwaysonAgBackupLocation,$alwaysonAgPrimaryReplicaServerInstance,$alwaysonAgSecondaryReplicaServerInstance,$AlwaysonAgPrimaryReplicaHostName,$AlwaysonAgSecondaryReplicaHostname,$DomainFull,$AlwaysonAgHadrEndpointPort,$AlwaysonAgPrimaryReplicaInstanceName


#Invoke-Command -ComputerName $SecondaryHostName -Authentication Credssp -Credential $credentials -ScriptBlock {
#param($AlwaysonAgSecondaryReplicaHostname, $AlwaysonAgSecondaryReplicaInstanceName,$alwaysonAgSecondaryReplicaServerInstance,$AlwaysonAgName,$AlwaysonAgDatabaseName,$alwaysonAgBackupLocation)
#[System.Reflection.Assembly]::LoadWithPartialName('Microsoft.SqlServer.SMO') | out-null
#$serverSecondary =New-Object ('Microsoft.SqlServer.Management.Smo.Server') $alwaysonAgSecondaryReplicaServerInstance 
...
Invoke-Command -ComputerName $SecondaryHostName -Authentication Credssp -Credential $credentials -ScriptBlock {
param($AlwaysonAgSecondaryReplicaHostname, $AlwaysonAgSecondaryReplicaInstanceName,$AlwaysonAgName,$AlwaysonAgDatabaseName,$alwaysonAgBackupLocation,$alwaysonAgSecondaryReplicaServerInstance)
Import-Module "sqlps" –DisableNameChecking
[System.Reflection.Assembly]::LoadWithPartialName('Microsoft.SqlServer.SMO') | out-null
$serverSecondary =New-Object ('Microsoft.SqlServer.Management.Smo.Server') $alwaysonAgSecondaryReplicaServerInstance 
...
} -ArgumentList $AlwaysonAgSecondaryReplicaHostname, $AlwaysonAgSecondaryReplicaInstanceName,$AlwaysonAgName,$AlwaysonAgDatabaseName,$alwaysonAgBackupLocation,$alwaysonAgSecondaryReplicaServerInstance


# Create Always On Listener

If ($AlwaysonListenerOption -eq $true) {
